...
QtObject
{
    ...
    ListModel
    {
        ...
        property string filename: "Fireworks.tar.gz"
        property string md5: "b687fc5722b14ad48968669e39cff846"
        property double size: 127.4

        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part01";
            size: 25.0
        }
        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part02";
            size: 25.0
        }
        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part03";
            size: 25.0
        }
        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part04";
            size: 25.0
        }
        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part05";
            size: 25.0
        }
        ListElement
        {
            url: "https://mythqml.net/downloads/themes/SlideShowFIREWORKS/Fireworks.tar.gz.part06";
            size: 2.4
        }
    }
    ...
    ListModel
    {
        ...
        ListElement
        {
            ...
            url: "relaxing_piano.webm";
            logo: "snapshot021.jpg"
        }
    }
